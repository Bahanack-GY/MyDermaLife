...
export class UpdateProductDto {
  @ApiPropertyOptional({ example: 'SKU-CREAM-001', description: 'Unique product SKU' })
  @IsOptional()
  @IsString()
  @MinLength(1)
  sku?: string;

  @ApiPropertyOptional({ example: 'Hydrating Face Cream', description: 'Product name' })
  @IsOptional()
  @IsString()
  @MinLength(2)
  name?: string;

  @ApiPropertyOptional({ example: 'hydrating-face-cream', description: 'URL-friendly slug' })
  @IsOptional()
  @IsString()
  @MinLength(2)
  slug?: string;
  ...
  @ApiPropertyOptional({ example: 15000, description: 'Price in smallest currency unit' })
  @IsOptional()
  @IsNumber()
  @Min(0)
  @Type(() => Number)
